   <div class="content-wrapper">
    ...
    <?php endif; ?>
          <h1>
            <i class="fa fa-archive"></i> Kategori Konsultasi
          </h1>
    </section>
    <!-- Main content -->
    ...
    <section class="content col-md-12">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Jenis Konsultasi</h3> <button class="pull-right btn btn-success" type="button" name="btn_tambah_kegiatan" id='btn_tambah'><i class="fa fa-plus" style="margin-right:5px"></i>Create New Jenis</button>
      </div>
      <div class="box-body" style="overflow-x:auto;">
        <table class="table table-responsive table-striped table-bordered table-hover text-left" >
          ...
          <tbody class="">
            <?php $no=1; foreach ($konsultasi->result() as $key): ?>
              <tr>
                <td><?php echo $no ?></td>
