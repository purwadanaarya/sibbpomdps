      ...
      <form action="<?php echo base_url('sertifikasi/sertifikasi/baru_process') ?>" method="post">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input class="form-control" value="" placeholder="Nama Konsumen" type="text" name="nama_konsumen">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label>Nama Perusahaan</label>
            <input class="form-control" value="" placeholder="Nama Perusahaan" type="text" name="nama_perusahaan">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label>Telepon Perusahaan</label>
            <input class="form-control" value="" placeholder="Telepon Perusahaan" type="number" name="telepon_perusahaan">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label>Alamat Perusahaan</label>
            <input class="form-control" value="" placeholder="Alamat Perusahaan" type="text" name="alamat_perusahaan">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input class="form-control" value="" placeholder="Email Perusahaan" type="email" name="email_perusahaan">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input class="form-control" value="" placeholder="Deskripsi Produk" type="text" name="detail_produk">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
